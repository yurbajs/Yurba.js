...
class Client extends events_1.EventEmitter {
    ...
    async sendMessage(dialogId, text, replyToId = null, photos_list = null, attachments = null, edit = null, repost = null) {
        ...
        try {
            ...
            const response = await axios_1.default.post(`https://api.yurba.one/dialogs/${dialogId}/messages`, messageData, {
    ...
    async getUser(userTag) {
        try {
            const response = await axios_1.default.get(`https://api.yurba.one/user/${userTag}`, {
    ...
    async getPhoto(photoId) {
        try {
            const response = await axios_1.default.get(`https://api.yurba.one/photos/${photoId}`);
    ...
    async deleteMessage(ID) {
        try {
            await axios_1.default.delete(`https://api.yurba.one/dialogs/messages/${ID}`, {
                headers: { 'Content-Type': 'application/json', token: this.token },
            });
            return true;
        }
