...
declare class Apis {
     ...
     */
    sendMessage(dialogId: number, text: string, replyToId?: number | null, photos_list?: number[] | null, attachments?: number[] | null, edit?: number | null, repost?: number | null): Promise<any>;
    /**
