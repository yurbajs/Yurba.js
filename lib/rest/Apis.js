...
class Apis {
   ...
   */
  async getMe() {
    const response = await axios_1.default.get(`${this.baseURL}/get_me`, {
   ...
   */
  async getUser(tag) {
    const response = await axios_1.default.get(`${this.baseURL}/user/${tag}`, {
      headers: this.headers,
    });
    return response.data;
  }
  ...
  async sendMessage(
    ...
    const response = await axios_1.default.post(
      `${this.baseURL}/dialogs/${dialogId}/messages`,
      messageData,
      { headers: this.headers },
    );
    return response.data;
  ...
  async deleteMessage(ID) {
    const response = await axios_1.default.delete(
      `${this.baseURL}/dialogs/messages/${ID}`,
      { headers: this.headers },
    );
    return response.data;
  }
   ...
   */
  async deleteAccount() {
    const response = await axios_1.default.delete(`${this.baseURL}/`, {
      headers: this.headers,
    });
    return response.data;
  }
  ...
  async getMessages(dialogId, last_id) {
    let response;
    if (last_id) {
      response = await axios_1.default.get(
        `${this.baseURL}/dialogs/${dialogId}/messages?last_id=${last_id}`,
        { headers: this.headers },
      );
    } else {
      response = await axios_1.default.get(
   ...
   */
  async getDialogs() {
    const response = await axios_1.default.get(`${this.baseURL}/dialogs`, {
      headers: this.headers,
    });
    return response.data;
  }
  ...
  async getDialogMembers(dialogId, last_id = 0) {
    const response = await axios_1.default.get(
      `${this.baseURL}/dialogs/${dialogId}/members?last_id=${last_id}`,
      { headers: this.headers },
    );
    return response.data;
  }
  ...
  async joinDialog(dialogId, userId) {
    const response = await axios_1.default.post(
      `${this.baseURL}/dialogs/${dialogId}/join/${userId}`,
      {},
      { headers: this.headers },
    );
    return response.data;
  ...
  async leaveDialog(dialogId, userId) {
    const response = await axios_1.default.delete(
      `${this.baseURL}/dialogs/${dialogId}/leave/${userId}`,
      { headers: this.headers },
    );
    return response.data;
  }
  ...
  async getUserPhotos(tag, page, mode = 0) {
    const response = await axios_1.default.get(
      `${this.baseURL}/user/${tag}/photos?page=${page}&mode=${mode}`,
      { headers: this.headers },
    );
    return response.data;
  }
  ...
  async createPlaylist(name, release, description, cover) {
    ...
    const response = await axios_1.default.post(
      `${this.baseURL}/musebase/playlists`,
      playlistData,
      { headers: this.headers },
    );
    return response.data;
  ...
  async deletePlaylist(playlistId) {
    const response = await axios_1.default.delete(
      `${this.baseURL}/musebase/playlists/${playlistId}`,
      { headers: this.headers },
    );
    return response.data;
  }
  ...
  async updatePlaylist(playlistId, name, release, description, cover) {
    const playlistData = { name, release, description, cover };
    const response = await axios_1.default.patch(
      `${this.baseURL}/musebase/playlists/${playlistId}`,
      playlistData,
      { headers: this.headers },
    );
  ...
  async addPlaylistTrack(playlistId, trackId) {
    const response = await axios_1.default.post(
      `${this.baseURL}/musebase/playlists/${playlistId}/tracks/${trackId}`,
      {},
      { headers: this.headers },
    );
    return response.data;
  ...
  async getUserPlaylists(tag) {
    const response = await axios_1.default.get(
      `${this.baseURL}/user/${tag}/playlists`,
      { headers: this.headers },
    );
    return response.data;
  }
  ...
  async getPosts(tag, lastId, lang, feed = false) {
    ...
    const response = await axios_1.default.get(
      `${this.baseURL}/user/${tag}/posts?last_id=${lastId}${language}&feed=${feed}`,
      { headers: this.headers },
    );
    return response.data;
  }
  ...
  async getComments(postId, lastId) {
    const response = await axios_1.default.get(
      `${this.baseURL}/posts/${postId}/comments?last_id=${lastId}`,
      { headers: this.headers },
    );
    return response.data;
  }
  ...
  async getNotifications(page = 0) {
    const response = await axios_1.default.get(
      `${this.baseURL}/notifications?page=${page}`,
      { headers: this.headers },
    );
    return response.data;
  }
   ...
   */
  async getCountries() {
    const response = await axios_1.default.get(`${this.baseURL}/countries`, {
      headers: this.headers,
    });
    return response.data;
  }
  ...
  async getCities(countryId, regionId) {
    const response = await axios_1.default.get(
      `${this.baseURL}/countries/${countryId}/regions/${regionId}/cities`,
      { headers: this.headers },
    );
    return response.data;
  }
   ...
   */
  async getLanguages() {
    const response = await axios_1.default.get(`${this.baseURL}/languages`, {
      headers: this.headers,
    });
    return response.data;
  }
   ...
   */
  async getUserPages() {
    const response = await axios_1.default.get(`${this.baseURL}/golink`, {
      headers: this.headers,
    });
    return response.data;
  }
  ...
  async getGdvsAccounts() {
    const response = await axios_1.default.get(
      `https://gdvs.yurba.one/api/accounts`,
      { headers: this.headers },
    );
    return response.data;
  }
  ...
  async getArticleRevision(revisionId) {
    const response = await axios_1.default.get(
      `${this.baseURL}/articles/revisions/${revisionId}`,
      { headers: this.headers },
    );
    return response.data;
  }
  ...
  async getFriends(tag, page) {
    const response = await axios_1.default.get(
      `${this.baseURL}/user/${tag}/friends?page=${page}`,
      { headers: this.headers },
    );
    return response.data;
  }
  ...
  async getIncomingRequests(page) {
    const response = await axios_1.default.get(
      `${this.baseURL}/incoming_requests?page=${page}`,
      { headers: this.headers },
    );
    return response.data;
  }
  ...
  async getOutcomingRequests(page) {
    const response = await axios_1.default.get(
      `${this.baseURL}/outcoming_requests?page=${page}`,
      { headers: this.headers },
    );
    return response.data;
  }
  ...
  async ignoreIncomingRequest(userId) {
    const response = await axios_1.default.delete(
      `${this.baseURL}/incoming_requests/${userId}`,
      { headers: this.headers },
    );
    return response.data;
  }
  ...
  async getRelationships(tag) {
    const response = await axios_1.default.get(
      `${this.baseURL}/user/${tag}/relationships`,
      { headers: this.headers },
    );
    return response.data;
  }
  ...
  async subscribeFriends(tag) {
    const response = await axios_1.default.patch(
      `${this.baseURL}/user/${tag}/subscribe`,
      {},
      { headers: this.headers },
    );
    return response.data;
   ...
   */
  async getUserApps() {
    const response = await axios_1.default.get(`${this.baseURL}/apps`, {
      headers: this.headers,
    });
    return response.data;
  }
  ...
  async getUserAppTokens() {
    const response = await axios_1.default.get(`${this.baseURL}/apps/tokens`, {
      headers: this.headers,
    });
    return response.data;
  }
  ...
  async createUserAppToken(publicKey, redirectUrl) {
    const response = await axios_1.default.post(
      `${this.baseURL}/apps/${publicKey}/token?redirectUrl=${redirectUrl}`,
      {},
      { headers: this.headers },
    );
    return response.data;
  ...
  async deleteUserAppToken(appToken, publicKey, redirectUrl) {
    const response = await axios_1.default.delete(
      `${this.baseURL}/apps/tokens/${appToken}?publicKey=${publicKey}&redirectUrl=${redirectUrl}`,
      { headers: this.headers },
    );
    return response.data;
  }
  ...
  async getApp(publicKey, redirectUrl) {
    const response = await axios_1.default.get(
      `${this.baseURL}/apps/${publicKey}?redirectUrl=${redirectUrl}`,
      { headers: this.headers },
    );
    return response.data;
  }
   ...
   */
  async logout() {
    const response = await axios_1.default.delete(`${this.baseURL}/logout`, {
      headers: this.headers,
    });
    return response.data;
  }
